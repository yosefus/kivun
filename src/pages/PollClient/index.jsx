...
import MultiAnswer from "../../components/FillPoll/multipleyAnswer";
import OpenQuestion from "../../components/FillPoll/OpenQuestion/OpenQuestion";
import RangQuestion from "../../components/FillPoll/OpenQuestion/RangQuestion";
import { savepolluser } from "../../functions/pollUser";
import SingleAnswer from "../../components/FillPoll/singleAnswer";
...
export default function PolClient() {
  const { id } = useParams();
